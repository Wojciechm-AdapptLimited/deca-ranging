...
INT_PTR ChanConfig(HWND, UINT, WPARAM, LPARAM);

INT_PTR ContFrameConfig(HWND, UINT, WPARAM, LPARAM);

INT_PTR CWModeConfig(HWND, UINT, WPARAM, LPARAM);

INT_PTR TagSelectAddress(HWND hDlg, UINT message, WPARAM wParam, LPARAM lParam);

INT_PTR TimingConfig(HWND, UINT, WPARAM, LPARAM);

INT_PTR RegAccess(HWND, UINT, WPARAM, LPARAM);

INT_PTR Reg2File(HWND, UINT, WPARAM, LPARAM);

INT_PTR File2Reg(HWND, UINT, WPARAM, LPARAM);
...
int inittestapplication(int reset) {
    ...
    if (initComplete == 0) // main init
    {
        ...
        EnableMenuItem(GetMenu(hWnd), IDM_REGACCESS,
    ...
    if (instance_mode == ANCHOR) {
        ...
        EnableMenuItem(GetMenu(hWnd), IDM_DISPCLKOFFSET,
...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow) {
...

    {
        ...
        hFont = (HFONT) GetStockObject(
                ANSI_VAR_FONT); // DEVICE_DEFAULT_FONT, SYSTEM_FONT or ANSI_VAR_FONT, ANSI_FIXED_FONT
/*
...
*/
        ...
        hMainPanel = CreateWindowEx(0, _T("Static"), NULL, WS_VISIBLE | WS_CHILD | WS_DLGFRAME, panx, pany,
                                    MAIN_PANEL_MIN_WIDTH, 150, hWnd, (HMENU)MAIN_PANEL_ID, NULL, NULL);
...

        {
            ...
            hDelayTextBox = CreateWindowEx(0, _T("Edit"), tempDelayString,
                                           ...
                                           panx + delx + 21, pany + dely + 20, 85, 20, hWnd, (HMENU)ANTENNA_DELAY_ID,
                                           NULL, NULL);
        ...
        hClrCountsButton = CreateWindowEx(0, _T("Button"), _T("Clear Counters"),
                                          BS_PUSHBUTTON | WS_VISIBLE | WS_CHILD | WS_TABSTOP,
                                          panx + 167, pany + 107, 108, 23, hWnd, (HMENU)CLEAR_COUNTS_BUTTON_ID, NULL,
                                          NULL);
            ...
            switch (wmId) {
				...
				*/
                ...
                case PREVACC_BUTTON_ID:
                    ...
                    SetFocus(
                            hWnd);                        // set focus to main window (away from the button) to allow key accelerators to work
                    break;
...
INT_PTR CWModeConfig(HWND hDlg, UINT message, WPARAM wParam, LPARAM lParam) {
    int wmId, wmEvent;
...
INT_PTR ContFrameConfig(HWND hDlg, UINT message, WPARAM wParam, LPARAM lParam) {
    int wmId, wmEvent;
...
INT_PTR ChanConfig(HWND hDlg, UINT message, WPARAM wParam, LPARAM lParam) {
    int wmId, wmEvent;
    HWND hCtrl;
...
INT_PTR RegAccess(HWND hDlg, UINT message, WPARAM wParam, LPARAM lParam) {
...
// -------------------------------------------------------------------------------------------------------------------
//
INT_PTR TimingConfig(HWND hDlg, UINT message, WPARAM wParam, LPARAM lParam) {
    int wmId, wmEvent;
